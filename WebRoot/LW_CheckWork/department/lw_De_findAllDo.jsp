		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li class="active"><a href="departmentList"> <i
							class="icon-text-width"></i> <span class="menu-text"> 部门管理</span>
					</a></li>
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<div class="nav-search" id="nav-search">
						<form action="departmentfindAll" class="form-search">
							<span class="input-icon"> <input type="text"
								name="departmentKW" placeholder="Search ..."
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							部门管理 <small> <i class="icon-double-angle-right"></i> 查看
								<form action="departmentinsert" name="insertForm" method="post"
						...
						<div class="col-xs-12">
							...
							<div align="center">
								<table border="1" class="persontable">
									<thead>
										<tr>
											<th style="width:200px;">部门编号</th>
											<th style="width:200px;">部门名称</th>
											<th style="width:200px;">负责人姓名</th>
											<th style="width:200px;">负责人联系方式</th>
											<th style="width:200px;">部门简介</th>
											<th style="width:200px;">部门人数</th>
											<th style="width:200px;">操作</th>
										</tr>
									</thead>

									<s:iterator value="deRePage">
										<tr>
											<td><s:property value="de_no" /></td>
											<td><s:property value="de_name" /></td>
											<td><s:property value="per_name" /></td>
											<td><s:property value="per_phone" /></td>
											<td><s:property value="de_info" /></td>
											<td><s:property value="de_perNum" /></td>
											<td><a
												href="departmentfind.action?de_no=<s:property value="de_no"/>">更改该信息</a><br>
												<a
												href="departmentdeleteDo.action?de_no=<s:property value="de_no"/>">删除该信息</a><br>
											</td>
										</tr>
									</s:iterator>
								</table>
