				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<!-- PAGE CONTENT BEGINS -->
							<center>
								<form action="departmentupdateDo" name="updateDoForm"
									method="post">
									部门编号&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
										name="departmentPage.de_no" value="${departmentPage.de_no}"
										value="readonly" readonly /><br> <br>
									部门名称&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
										name="departmentPage.de_name"
										value="${departmentPage.de_name}"><br> <br>
									负责人姓名&nbsp;&nbsp;&nbsp; <input type="text"
										name="departmentPage.per_name"
										value="${departmentPage.per_name}" /><br> <br>
									负责人联系方式&nbsp; <input type="text"
										name="departmentPage.per_phone"
										value="${departmentPage.per_phone}"><br> <br>
									部门信息&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
										name="departmentPage.de_info"
										value="${departmentPage.de_info}"><br> <br>
									部门人数&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
										name="departmentPage.de_perNum"
										value="${departmentPage.de_perNum}"><br> <br>
