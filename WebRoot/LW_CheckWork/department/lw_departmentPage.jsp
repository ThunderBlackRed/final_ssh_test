			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">部门</strong> / <small>基本信息</small>
					</div>
				</div>
							...
							<table
								...
								<thead>
									<tr>
										...
										<th class="table-title"><center>部门</center></th>
										<th class="table-title"><center>部门人数</center></th>
										<th class="table-type"><center>负责人</center></th>
										<th class="table-author am-hide-sm-only"><center>职位</center></th>
										<th class="table-date am-hide-sm-only"><center>联系方式</center></th>
								...
								<tbody>
									<tr>
										...
										<td><center>张苏纳</center></td>
										<td class="am-hide-sm-only"><center>项目经理</center></td>
										<td class="am-hide-sm-only"><center>18770654256
											</center></td>
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
