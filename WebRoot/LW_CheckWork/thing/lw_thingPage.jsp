			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">审批</strong> / <small>员工申请</small>
					</div>
				</div>
							...
							<table
								...
								<thead>
									<tr>
										...
										<th class="table-title"><center>申请类型</center></th>
										<th class="table-type"><center>申请人</center></th>
										<th class="table-author am-hide-sm-only"><center>申请原因</center></th>
										<th class="table-author am-hide-sm-only"><center>申请时长(天)</center></th>
										<th class="table-date am-hide-sm-only"><center>审核人</center></th>
										<th class="table-date am-hide-sm-only"><center>审核状态</center></th>
								...
								<tbody>
									<tr>
										...
										<td>1</td>
										<td><center>休假</center></td>
										<td><a href="#">
												<center>张苏纳</center>
										</a></td>
										<td><center>想要请假休息</center></td>
										<td class="am-hide-sm-only"><center>3</center></td>
										<td><a href="#">
												<center>王柳</center>
										</a></td>
										<td class="am-hide-sm-only"><center>
												<select data-am-selected="{btnSize: 'sm'}">
													<option value="option1"><center>未审批</center>
													</option>
													<option value="option2"><center>通过</center>
													</option>
													<option value="option3"><center>拒绝</center>
													</option>
												</select>
											</center></td>
										<td>
