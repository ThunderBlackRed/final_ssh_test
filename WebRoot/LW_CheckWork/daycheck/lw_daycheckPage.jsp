...
<body>
	...
	<div class="main-container" id="main-container">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li><a href="MCList"> <i class="icon-list-alt"></i> <span
							class="menu-text"> 考勤管理 </span>
					</a></li>

					<li><a href="ThingList"> <i class="icon-picture"></i> <span
							class="menu-text"> 差假管理 </span>
					</a></li>

					<li><a href="Gonggaofind"> <i class="icon-picture"></i> <span
							class="menu-text"> 公告管理 </span>
					</a></li>
					<li class="active"><a href="PeoplefindCheckHoutai"> <i
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							打卡管理 <small> <i class="icon-double-angle-right"></i> 查看
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
								...
								<table class="persontable">
									<thead>
										<tr>
											...
											<th style="width:200px;">考勤时间</th>
											<th style="width:200px;">状态</th>
										</tr>
									</thead>
									<s:iterator value="DCpage">
										<tr>
		...
		return "";
								...
								页&nbsp;&nbsp;
								<s:url id="url_pre" value="PeoplefindCheckHoutai.action">
									<s:param name="pageNow" value="pageNow-1"></s:param>
								</s:url>

								<s:url id="url_next" value="PeoplefindCheckHoutai.action">
									<s:param name="pageNow" value="pageNow+1"></s:param>
								</s:url>
								<s:iterator value="Newss" status="status">
									<s:url id="url" value="PeoplefindCheckHoutai.action">
