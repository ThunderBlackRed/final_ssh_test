...
<body class="templatemo-bg-gray">
	<div class="container">
		<div class="col-md-12">
			<h1 class="text-center margin-bottom-15">考勤查询</h1>
			<form
				...
				<div class="row">
					<div align="center">
						...
						页&nbsp;&nbsp;
						<s:url id="url_pre" value="PeoplefindCheck.action">
							<s:param name="pageNow" value="pageNow-1"></s:param>
						</s:url>

						<s:url id="url_next" value="PeoplefindCheck.action">
							<s:param name="pageNow" value="pageNow+1"></s:param>
						</s:url>
						<s:iterator value="Newss" status="status">
							<s:url id="url" value="PeoplefindCheck.action">
