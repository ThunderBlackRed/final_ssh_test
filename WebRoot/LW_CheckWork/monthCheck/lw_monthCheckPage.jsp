			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">员工</strong> / <small>考勤记录</small>
					</div>
				</div>
							...
							<table
								...
								<thead>
									<tr>
										...
										<th class="table-title"><center>姓名</center></th>
										<th class="table-type"><center>部门</center></th>
										<th class="table-author am-hide-sm-only"><center>出勤
												| 应出勤(天)</center></th>
										<th class="table-date am-hide-sm-only"><center>缺勤
												(天)</center></th>
								...
								<tbody>
									<tr>
										...
										<td><center>费用控制部</center></td>
										<td class="am-hide-sm-only"><center>20 | 22</center></td>
										<td class="am-hide-sm-only"><center>2</center></td>
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button
