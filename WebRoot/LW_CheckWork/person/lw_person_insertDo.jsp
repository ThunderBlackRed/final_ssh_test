		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="PersonList"> <i class="icon-dashboard"></i> <span
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<!-- PAGE CONTENT BEGINS -->
							<center>
							<form action="PersoninsertDo" name="insertDoForm" method="post">
								员工姓名&nbsp;&nbsp;<input type="text"
									name="personPage.per_name" /><br><br>
								员工职位&nbsp;&nbsp;<input
									type="text" name="personPage.per_post" /><br><br>
								部门编号&nbsp;&nbsp;<input
									type="text" name="personPage.de_no" placeholder="DE01"/><br><br>
								部门名称&nbsp;&nbsp;<input type="text"
									name="personPage.de_name" placeholder="人事部"/><br><br>
								联系方式&nbsp;&nbsp;<input type="text"
									name="personPage.per_phone" /><br><br> 
								性别&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"
									name="personPage.per_sex" /><br><br>
								管理员标识&nbsp;<input type="text"
									name="personPage.per_admin" placeholder="0/1"/><br><br>
								登录密码&nbsp;&nbsp;<input type="text"
									name="personPage.per_pwd" /><br><br><input
