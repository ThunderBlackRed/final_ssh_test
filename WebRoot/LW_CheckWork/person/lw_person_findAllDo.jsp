		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="PersonList"> <i
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">公司员工</li>
					</ul>
					<!-- .breadcrumb -->

					<div class="nav-search" id="nav-search">
						<form action="PersonfindAll" class="form-search">
							<span class="input-icon"> <input type="text" name="PersonKW"
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							员工管理 <small> <i class="icon-double-angle-right"></i> 查看
								<form action="Personinsert" name="insertForm" method="post"
								...
								<table border="1" class="persontable">
									...
									<thead>
										<tr>
											...
											<th style="width:200px;">职位</th>
											<th style="width:200px;">所属部门编号</th>
											<th style="width:200px;">所属部门名称</th>
											<th style="width:200px;">联系方式</th>
											<th style="width:200px;">性别</th>
											<th style="width:200px;">管理员标志（1为管理员）</th>
									...
									<s:iterator value="PersonRePage">
										<tr>
											<td><s:property value="per_no" />
											</td>
											<td><s:property value="per_name" />
											</td>
											<td><s:property value="per_post" />
											</td>
											<td><s:property value="de_no" />
											</td>
											<td><s:property value="de_name" />
											</td>
											<td><s:property value="per_phone" />
											</td>
											<td><s:property value="per_sex" />
											</td>
											<td><s:property value="per_admin" />
											</td>
											<td><s:property value="per_pwd" />
											</td>
											<td><a
												href="Personfind.action?per_no=<s:property value="per_no"/>">更新</a><br>
											</td>
											<td><a
												href="PersondeleteDo.action?per_no=<s:property value="per_no"/>">删除</a><br>
											</td>
										</tr>
									</s:iterator>
								</table>
